...
public enum ServiceType {
    ...
    REGISTRATION_SUS_CANCELLATION(15, "Suspension-Cancellation-Objection of Registration", "RSC"),THEFT_INTIMATION(16, "Theft Intimation", "TI"),
    ...
    REGISTRATION_CANCELLATION(19, "Cancellation of Registration", "RC"),FRESH_REGISTRATION(22, "FRESH REGISTRATION", "FREG"),
    // TAX
    STOPPAGE_TAX(200, "Stoppage Tax", "ST"), STOPPAGE_TAX_REVOCATION(200, "Stoppage Tax Revocation", "STR"), DIFFERENTIAL_TAX(222, "Differential Tax", "DT"), 
    // LL/DL
    ...
    FC_RE_INSPECTION_SB(503, "Fitness Re Inspection SlotBooking", "FCSB"),FC_OTHER_STATION(504, "Fitness Other Station", "FCOS"),
    ...
    public static ServiceType getServiceType(String code) {
        ...
        } else if (code.toUpperCase().equals(REGISTRATION_SUS_CANCELLATION.getCode())) {
            return ServiceType.REGISTRATION_SUS_CANCELLATION;
